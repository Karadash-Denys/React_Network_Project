...
const user_page_reduser = (state = initionalUserPage, action: any): InitialStateType => {
...
const followUnfollowFloe = async(dispatch: any,userID: number,methodAPI:any,actionCreator:any) => {
